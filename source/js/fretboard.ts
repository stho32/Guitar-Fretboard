...
class Steg
{
    ...
    constructor(anzahlBuende: number)
    {
        this.Saite = [];
...
class Saite
{
    ...
    constructor(ersteNote : Note, anzahlBuende : number)
    {
        this.Buende = [];
...
class Note
{
    ...
    MarkierungswunschEnthaelt(markierungsliste, note, oktave) : boolean
    {
...
function istBundSichtbar(bund : number)
{
    if ($("#buende").val() == "")
        return true;
...
$(document).ready(
  function()
  {
      ...
      $("#gruen").keyup(function (){$("#fretboard").html(Fretboard());});
      $("#orange").keyup(function (){$("#fretboard").html(Fretboard());});
      $("#rot").keyup(function (){$("#fretboard").html(Fretboard());});
      $("#buende").keyup(function (){$("#fretboard").html(Fretboard());});
  }
);